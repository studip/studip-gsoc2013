...
if (($showrangeID) && ($voteaction != "search")){
    if (($perm->have_studip_perm("tutor",$showrangeID)) ||
        ...
        $safeguard = printSafeguard("ausruf",_("Sie haben keine Berechtigung für diesen Bereich oder der Bereich existiert nicht. Es werden Umfragen und Tests Ihrer Profilseite angezeigt."));
